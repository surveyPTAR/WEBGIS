!(function (e) {
     ...
     function (e, t, r) {
          function n(e, t) {
               ...
               for (var y in e)
                    (!t && !f.call(e, y)) ||
                         (h && ("length" == y || (c && ("offset" == y || "parent" == y)) || (p && ("buffer" == y || "byteLength" == y || "byteOffset" == y)) || u(y, m))) ||
                         d.push(y);
               return d;
          }
          var o = r(51),
     ...
     function (e, t, r) {
          ...
          function n(e, t, r) {
               if (null !== e)
                    for (
                         var o, i, s, a, u, l, c, f, p = 0, h = 0, d = e.type, m = "FeatureCollection" === d, y = "Feature" === d, v = m ? e.features.length : 1, g = 0;
                         g < v;
                         g++
                    ) {
          ...
          (L.Control.Measure = L.Control.extend({
               ...
               _handleMeasureMove: function (e) {
                    this._measureDrag
                         ...
                         : (this._measureDrag = L.circleMarker(e.latlng, this._symbols.getSymbol("measureDrag")).addTo(this._layer)),
               ...
               _handleMeasureDoubleClick: function () {
                    ...
                    if ((this._finishMeasure(), e.length)) {
                         ...
                         1 === e.length
                              ...
                              : 2 === e.length
                              ? ((t = L.polyline(e, this._symbols.getSymbol("resultLine"))), (r = _({ model: L.extend({}, n, this._getMeasurementDisplayStrings(n)) })))
                              : ((t = L.polygon(e, this._symbols.getSymbol("resultArea"))), (r = j({ model: L.extend({}, n, this._getMeasurementDisplayStrings(n)) })));
                         ...
                         i &&
                              ...
                              L.DomEvent.on(
                                   ...
                                   "click",
                                   function () {
                                        t.getBounds ? this._map.fitBounds(t.getBounds(), { padding: [20, 20], maxZoom: 17 }) : t.getLatLng && this._map.panTo(t.getLatLng());
                                   },
                                   this
                              ));
               ...
               _addMeasureBoundary: function (e) {
                    ...
                    this._measureBoundary
                         ...
                         : (this._measureBoundary = L.polyline(e, this._symbols.getSymbol("measureBoundary")).addTo(this._layer));
               },
          })),
     ...
     function (e, t, r) {
          ...
          function s(e) {
               ...
               if (f > 2) {
                    for (u = 0; u < f; u++)
                         u === f - 2 ? ((o = f - 2), (i = f - 1), (s = 0)) : u === f - 1 ? ((o = f - 1), (i = 0), (s = 1)) : ((o = u), (i = u + 1), (s = u + 2)),
                              (t = e[o]),
                              (r = e[i]),
                              (n = e[s]),
                         ...
                         o(e, [
                              {
                                   ...
                                   value: function (e) {
                                        return {
                                             ...
                                             measureArea: { clickable: !1, stroke: !1, fillColor: this._options.activeColor, fillOpacity: 0.2, className: "layer-measurearea" },
                                             measureBoundary: {
                                                  clickable: !1,
                                                  color: this._options.activeColor,
                                                  weight: 2,
     ...
     function (e, t, r) {
          e.exports =
               '<h5>Linear measurement</h5> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this line</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ';
     },
     function (e, t, r) {
          e.exports =
               '<h5>Area measurement</h5> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perimeter</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ';
     },
]);
